...
var svgWhiteList_ = {
  ...
  "foreignObject": ["class", "font-size", "height", "id", "opacity", "requiredFeatures", "style", "transform", "width", "x", "y","xml:space","stroke-width","stroke","fill"],
  "div": ["class", "id", "style", "transform", "width", "x", "y","contenteditable","requiredFeatures"],
  "p": ["class", "id", "style", "transform", "width", "x", "y"],
  "span": ["class", "id", "style", "transform", "width", "x", "y"],
